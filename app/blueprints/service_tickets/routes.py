...
from app.blueprints.service_tickets.schemas import ticket_create_schema, ticket_return_schema, tickets_return_schema  # service_ticket_assign_mechanic_schema, service_ticket_remove_mechanic_schema, service_ticket_assign_inventory_schema
...
# How is the mapping of inventory_items and mechanic_ids different (since one is handled as a association table and the other is a object)?
    ...
    # try:
    #     ticket_data = ticket_return_schema.load(request.json)
    # except ValidationError as e:
    #     return jsonify(e.messages), 400
    ...
    # return ticket_return_schema.jsonify(new_ticket), 201
...
#     try:
#         assign_mechanics = service_ticket_assign_mechanic_schema.load(request.json)
#     except ValidationError as e:
#         return jsonify(e.messages), 400
...
#     try:
#         remove_mechanics = service_ticket_remove_mechanic_schema.load(request.json)
#     except ValidationError as e:
#         return jsonify(e.messages), 400
